...
public class MenuView 
{
    ...
    public MenuView() throws IOException 
    {
		...
		{			
			...
			File pathmenu  = new File("src/main/java/FAKEINVADERS_Images/menu.jpg");
		...
		ImageIcon iconStartNewGameHover = new ImageIcon("src/main/java/FAKEINVADERS_Images/newGamePush.png");
		
		ImageIcon iconScore = new ImageIcon("src/main/java/FAKEINVADERS_Images/score.png");
		ImageIcon iconScoreHover = new ImageIcon("src/main/java/FAKEINVADERS_Images/scorePush.png");
		
		ImageIcon iconRules = new ImageIcon("src/main/java/FAKEINVADERS_Images/rules.png");
		ImageIcon iconRulesHover = new ImageIcon("src/main/java/FAKEINVADERS_Images/rulesPush.png");
		
		ImageIcon iconExit = new ImageIcon("src/main/java/FAKEINVADERS_Images/exit.png");
		ImageIcon iconExitHover = new ImageIcon("src/main/java/FAKEINVADERS_Images/exitPush.png");
