...
public class LoginView 
{
    ...
    public LoginView() throws IOException 
    {
        ...
        ImageIcon iconLogin = new ImageIcon("src/main/java/FAKEINVADERS_Images/login.png");
		ImageIcon iconLoginPush = new ImageIcon("src/main/java/FAKEINVADERS_Images/loginPush.png");
		
		ImageIcon iconU = new ImageIcon("src/main/java/FAKEINVADERS_Images/username.png");
		ImageIcon iconP = new ImageIcon("src/main/java/FAKEINVADERS_Images/password.png");
		
		ImageIcon iconSingin = new ImageIcon("src/main/java/FAKEINVADERS_Images/signin.png");
		ImageIcon iconSinginPush = new ImageIcon("src/main/java/FAKEINVADERS_Images/signinPush.png");
